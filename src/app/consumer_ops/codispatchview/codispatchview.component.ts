...
@Component({
  selector: 'smart360-codispatchview',
  templateUrl: './codispatchview.component.html',
  styleUrls: ['./codispatchview.component.scss']
})
export class CodispatchviewComponent implements OnInit {
