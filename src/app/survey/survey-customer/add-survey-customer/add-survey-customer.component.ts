...
@Component({
  selector: 'smart360-add-survey-customer',
  templateUrl: './add-survey-customer.component.html',
  styleUrls: ['./add-survey-customer.component.scss']
})
export class AddSurveyCustomerComponent implements OnInit {
  ...
  ngOnInit(): void { 
    ...
    $(document).ready(function(){
      ...
      $('#consumer-survey-rvw-sbmt-tab').on('shown.bs.tab', function(e) {
        $('#survey-dtls-tab').parent(".list-group-item").removeClass("active").addClass("finished");  
      ...
      $("#survey_vendor_assign").on('click', function(){
        $('#consumer-survey-rvw-sbmt-tab').trigger( "click" );
      });
      $("#consumer-survey-priview").on('click', function(){
