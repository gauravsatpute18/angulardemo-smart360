...
@Component({
  selector: 'smart360-side-nav-consops',
  templateUrl: './side-nav-consops.component.html',
  styleUrls: ['./side-nav-consops.component.scss']
})
export class SideNavConsopsComponent implements OnInit {
