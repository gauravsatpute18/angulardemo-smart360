...
@Component({
  selector: 'smart360-side-nav-snm',
  templateUrl: './side-nav-snm.component.html',
  styleUrls: ['./side-nav-snm.component.scss']
})
export class SideNavSnmComponent implements OnInit {
