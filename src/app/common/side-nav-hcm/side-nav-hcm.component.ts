...
@Component({
  selector: 'smart360-side-nav-hcm',
  templateUrl: './side-nav-hcm.component.html',
  styleUrls: ['./side-nav-hcm.component.scss']
})
export class SideNavHcmComponent implements OnInit {
