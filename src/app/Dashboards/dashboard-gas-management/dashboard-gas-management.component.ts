...
@Component({
  selector: 'smart360-dashboard-gas-management',
  templateUrl: './dashboard-gas-management.component.html',
  styleUrls: ['./dashboard-gas-management.component.scss']
})
export class DashboardGasManagementComponent implements OnInit {
