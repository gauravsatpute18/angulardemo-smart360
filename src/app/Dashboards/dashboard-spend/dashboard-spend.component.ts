...
@Component({
  selector: 'smart360-dashboard-spend',
  templateUrl: './dashboard-spend.component.html',
  styleUrls: ['./dashboard-spend.component.scss']
})
export class DashboardSpendComponent implements OnInit {
