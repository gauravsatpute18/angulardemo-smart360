...
@Component({
  selector: 'smart360-dashboard-hcm',
  templateUrl: './dashboard-hcm.component.html',
  styleUrls: ['./dashboard-hcm.component.scss']
})
export class DashboardHcmComponent implements OnInit {
