...
@Component({
  selector: 'smart360-dashboard-consumer-care',
  templateUrl: './dashboard-consumer-care.component.html',
  styleUrls: ['./dashboard-consumer-care.component.scss']
})
export class DashboardConsumerCareComponent implements OnInit {
