...
@Component({
  selector: 'smart360-dashboard-work-order',
  templateUrl: './dashboard-work-order.component.html',
  styleUrls: ['./dashboard-work-order.component.scss']
})
export class DashboardWorkOrderComponent implements OnInit {
