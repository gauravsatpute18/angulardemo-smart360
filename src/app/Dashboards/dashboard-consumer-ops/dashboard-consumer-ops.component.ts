...
@Component({
  selector: 'smart360-dashboard-consumer-ops',
  templateUrl: './dashboard-consumer-ops.component.html',
  styleUrls: ['./dashboard-consumer-ops.component.scss']
})
export class DashboardConsumerOpsComponent implements OnInit {
