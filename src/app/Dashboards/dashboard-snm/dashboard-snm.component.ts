...
@Component({
  selector: 'smart360-dashboard-snm',
  templateUrl: './dashboard-snm.component.html',
  styleUrls: ['./dashboard-snm.component.scss']
})
export class DashboardSnmComponent implements OnInit {
  ...
  month2 = [
    {id: 1, month: ' Last 30 days'},
    {id: 2, month: ' Last 60 days'},
    {id: 3, month: ' Last 90 days'},
    {id: 4, month: ' All'},
  ];
  ...
  ngOnInit(): void {
    ...
    $(document).ready(function(){
      ...
      $('smart360-header, smart360-side-nav-snm, smart360-footer').css('display', 'block');
