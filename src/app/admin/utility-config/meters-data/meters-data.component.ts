...
@Component({
  selector: 'smart360-meters-data',
  templateUrl: './meters-data.component.html',
  styleUrls: ['./meters-data.component.scss']
})
export class MetersDataComponent implements OnInit {
