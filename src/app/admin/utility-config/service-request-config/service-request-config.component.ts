...
@Component({
  selector: 'smart360-service-request-config',
  templateUrl: './service-request-config.component.html',
  styleUrls: ['./service-request-config.component.scss']
})
export class ServiceRequestConfigComponent implements OnInit {
