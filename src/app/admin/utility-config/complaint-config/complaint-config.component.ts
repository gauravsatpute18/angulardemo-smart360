...
@Component({
  selector: 'smart360-complaint-config',
  templateUrl: './complaint-config.component.html',
  styleUrls: ['./complaint-config.component.scss']
})
export class ComplaintConfigComponent implements OnInit {
