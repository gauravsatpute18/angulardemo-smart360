...
@Component({
  selector: 'smart360-work-order-config',
  templateUrl: './work-order-config.component.html',
  styleUrls: ['./work-order-config.component.scss']
})
export class WorkOrderConfigComponent implements OnInit {
