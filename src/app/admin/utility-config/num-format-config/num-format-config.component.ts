...
@Component({
  selector: 'smart360-num-format-config',
  templateUrl: './num-format-config.component.html',
  styleUrls: ['./num-format-config.component.scss']
})
export class NumFormatConfigComponent implements OnInit {
