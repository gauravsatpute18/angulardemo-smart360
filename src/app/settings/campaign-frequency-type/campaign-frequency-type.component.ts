...
@Component({
  selector: 'smart360-campaign-frequency-type',
  templateUrl: './campaign-frequency-type.component.html',
  styleUrls: ['./campaign-frequency-type.component.scss']
})
export class CampaignFrequencyTypeComponent implements OnInit {
